  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        text={`This creates a real account for ${approveTarget?.full_name || 'this applicant'} and emails ${approveTarget?.email ?? 'them'} a link to set up sign-in. They'll be added to the mentor list below with booking OFF until you turn it on.`}
        onCancel={() => setApproveTarget(null)}
        onConfirm={() => {
          if (approveTarget) { onSetStatus(approveTarget.id, 'approved'); }
