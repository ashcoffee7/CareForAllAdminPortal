...
import { useMapathonDates, type MapathonDate } from './useMapathonDates';
...
import { MapathonDateEditModal } from './MapathonDateEditModal';
...
export function ResourcesPage() {
  ...
  const { dates, createDate, updateDate, deleteDate } = useMapathonDates();
  ...
  return (
    <>
      ...
      <Card>
        <div className="flex items-center justify-between flex-wrap gap-[10px] mb-[6px]">
          <div className="font-heading text-[16px] text-text tracking-[0.01em] flex items-center gap-[9px]">
            <i className="ti ti-calendar-event" /> Mapathon Dates
          </div>
        ...
        <div className="text-[12.5px] text-muted mb-[18px]">Members pick from this list on the Mapathon Time Log form -- hours here are what gets credited for that date.</div>
