...
const PATCHABLE_FIELDS = ['first_name', 'last_name', 'role', 'gender', 'education_level', 'date_of_birth', 'chapter_id', 'calendly_url', 'avatar_url'] as const satisfies readonly (keyof ProfileUpdate)[];
