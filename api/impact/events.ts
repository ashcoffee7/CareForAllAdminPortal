...
// Ported from the old useImpactEvents.ts client hook: builds the event
// series the Impact Measurables page charts (member/chapter growth over
// time, plus one series per primary/secondary impact category logged on
// approved service_logs).
